...
public class ElasticSearchClient {
     ...
     * 文档类型名称 =》 数据库名
     */
    private static final String INDEX_TYPE = "wenda";
     ...
     * @return 查询结果
     */
    public JSONArray searchHighlight(QueryBuilder queryBuilder,String word,String type, List<String> highlightFieldList
            , int pageNo, int pageSize) {

        List<String> jobTitles=new ArrayList<>();
        CompletionSuggestionBuilder titleNameSuggest=new CompletionSuggestionBuilder("jobTitleNameSuggest");
        titleNameSuggest.text(word);
//        titleNameSuggest.field("text");
